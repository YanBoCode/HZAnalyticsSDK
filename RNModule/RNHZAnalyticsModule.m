...
#import "RNHZAnalyticsModule.h"
#import "SAReactNativeManager.h"
#import "SAReactNativeEventProperty.h"
#import <HZAnalyticsSDK/HZAnalyticsSDKManager.h>

NSString *const kSAReactNativePluginVersion = @"react_native:2.3.7";

@implementation RNHZAnalyticsModule

RCT_EXPORT_MODULE(RNHZAnalyticsModule)
...
RCT_EXPORT_METHOD(track:(NSString *)event withProperties:(NSDictionary *)propertyDict){
    @try {
        ...
        [[HZAnalyticsSDKManager sharedInstance] track:event withProperties:properties];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(trackTimerStart:(NSString *)event){
    @try {
        [[HZAnalyticsSDKManager sharedInstance] trackTimerStart:event];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(trackTimerEnd:(NSString *)event withProperties:(NSDictionary *)propertyDict){
    @try {
        NSDictionary *properties = [SAReactNativeEventProperty eventProperties:propertyDict];
//        [[HZAnalyticsSDKManager sharedInstance] trackTimerEnd:event withProperties:properties];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(trackInstallation:(NSString *)event withProperties:(NSDictionary *)propertyDict){
    @try {
//        [[HZAnalyticsSDKManager sharedInstance] trackInstallation:event withProperties:propertyDict];
      NSLog(@"小博1");
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
...
//        [[HZAnalyticsSDKManager sharedInstance] login:loginId withProperties:properties];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(logout){
    @try {
//        [[HZAnalyticsSDKManager sharedInstance] logout];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(trackViewScreen:(NSString *)url withProperties:(NSDictionary *)properties){
    @try {
//        [[HZAnalyticsSDKManager sharedInstance] trackViewScreen:url properties:properties autoTrack:NO];
...
RCT_EXPORT_METHOD(set:(NSDictionary *)profileDict){
    @try {
//        [[HZAnalyticsSDKManager sharedInstance] set:profileDict];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(setOnce:(NSDictionary *)profileDict){
    @try {
//        [[HZAnalyticsSDKManager sharedInstance] setOnce:profileDict];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(unset:(NSString *) profile){
    @try {
        [[HZAnalyticsSDKManager sharedInstance] unset:profile];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(increment:(NSString *)profile by:(nonnull NSNumber *)amount){
    @try {
        [[HZAnalyticsSDKManager sharedInstance] increment:profile by:amount];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
//        [[HZAnalyticsSDKManager sharedInstance] append:profile by:setCntent];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(deleteUser){
    @try {
//        [[HZAnalyticsSDKManager sharedInstance] deleteUser];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(clearKeychainData){
    @try {
//        [[HZAnalyticsSDKManager sharedInstance] clearKeychainData];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_BLOCKING_SYNCHRONOUS_METHOD(getDistinctId){
    @try {
//        NSString *bestId = [HZAnalyticsSDKManager sharedInstance].loginId;
//        if (bestId == nil) {
//            bestId = [HZAnalyticsSDKManager sharedInstance].distinctId;
//        }
//        if (bestId == nil) {
//            [[HZAnalyticsSDKManager sharedInstance] resetAnonymousId];
//            bestId = [HZAnalyticsSDKManager sharedInstance].anonymousId;
//        }
        return @"";
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
...
RCT_EXPORT_METHOD(getAnonymousIdPromise:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject){
    @try {
      resolve(@"1111");
//        resolve([HZAnalyticsSDKManager sharedInstance].anonymousId);
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(registerSuperProperties:(NSDictionary *)properties){
    @try {
//        [[HZAnalyticsSDKManager sharedInstance] registerSuperProperties:properties];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(unregisterSuperProperty:(NSString *)property){
    @try {
//        [[HZAnalyticsSDKManager sharedInstance] unregisterSuperProperty:property];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(clearSuperProperties){
    @try {
//        [[HZAnalyticsSDKManager sharedInstance] clearSuperProperties];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(flush){
    @try {
        [[HZAnalyticsSDKManager sharedInstance] flush];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(deleteAll){
    @try {
        [[HZAnalyticsSDKManager sharedInstance] deleteAll];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(identify:(NSString *)anonymousId) {
    @try {
//        [[HZAnalyticsSDKManager sharedInstance] identify:anonymousId];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(trackTimerPause:(NSString *)event){
    @try {
        [[HZAnalyticsSDKManager sharedInstance] trackTimerPause:event];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(trackTimerResume:(NSString *)event){
    @try {
        [[HZAnalyticsSDKManager sharedInstance] trackTimerResume:event];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(profilePushId:(NSString *)pushTypeKey pushId:(NSString *)pushId){
    @try {
//        [[HZAnalyticsSDKManager sharedInstance] profilePushKey:pushTypeKey pushId:pushId];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(profileUnsetPushId:(NSString *)pushTypeKey) {
    @try {
//        [[HZAnalyticsSDKManager sharedInstance] profileUnsetPushKey:pushTypeKey];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(getSuperPropertiesPromise:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject) {
    @try {
//        NSDictionary *superProperties = [[HZAnalyticsSDKManager sharedInstance] currentSuperProperties];
      resolve(@{});
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
...
RCT_EXPORT_METHOD(setServerUrl:(NSString *)serverUrl) {
    @try {
        [[HZAnalyticsSDKManager sharedInstance] setServerUrl:serverUrl];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(itemSet:(NSString *)itemType itemId:(NSString *)itemId properties:(nullable NSDictionary <NSString *, id> *)propertyDict) {
    @try {
//        [[HZAnalyticsSDKManager sharedInstance] itemSetWithType:itemType itemId:itemId properties:propertyDict];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(itemDelete:(NSString *)itemType itemId:(NSString *)itemId) {
    @try {
//        [[HZAnalyticsSDKManager sharedInstance] itemDeleteWithType:itemType itemId:itemId];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(getPresetPropertiesPromise:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject) {
    @try {
//        NSDictionary *presetProperties = [[HZAnalyticsSDKManager sharedInstance] getPresetProperties];
      resolve(@{});
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
...
RCT_EXPORT_METHOD(setFlushNetworkPolicy:(NSInteger)networkType) {
    @try {
//        [[HZAnalyticsSDKManager sharedInstance] setFlushNetworkPolicy:networkType];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(getLoginIdPromise:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject) {
    @try {
//        resolve([[HZAnalyticsSDKManager sharedInstance] loginId]);
      resolve(@"");
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
...
RCT_EXPORT_METHOD(isAutoTrackEnabledPromise:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject) {
    @try {
        resolve(@([[HZAnalyticsSDKManager sharedInstance] isAutoTrackEnabled]));
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(isVisualizedAutoTrackEnabledPromise:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject) {
    @try {
//        resolve(@([[HZAnalyticsSDKManager sharedInstance] isVisualizedAutoTrackEnabled]));
      resolve(@(YES));
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
...
//    @try {
//        [[HZAnalyticsSDKManager sharedInstance] trackInstallation:@"$AppInstall" withProperties:property];
//    } @catch (NSException *exception) {
//        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
//    }
}
...
RCT_EXPORT_METHOD(bind:(NSString *)key value:(NSString *)value) {
    @try {
        [[HZAnalyticsSDKManager sharedInstance] bind:key value:value];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
...
RCT_EXPORT_METHOD(unbind:(NSString *)key value:(NSString *)value) {
    @try {
        [[HZAnalyticsSDKManager sharedInstance] unbind:key value:value];
    } @catch (NSException *exception) {
        NSLog(@"[RNSensorsAnalytics] error:%@",exception);
    }
}
